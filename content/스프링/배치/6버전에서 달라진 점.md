...
[레포 링크](https://github.com/spring-projects/spring-batch/releases/tag/v6.0.0)
## 도메인 모델의 불변성 강화
...
- 기존처럼 구현하면 자동으로 `ChunkOrientedStep`으로 구현된다.
...
## 기타
- `JobLauncher` 대신에 이를 확장한 [[JobOperator|Job Operaetor]]를 사용
